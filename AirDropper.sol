...
// File contracts/toolbox/AirDropper.sol
...
contract AirDropper is Ownable{
    ...
    function AirDropDiffAMT(IERC20 token, address payable[] calldata to, uint256[] calldata amount) payable external{
    ...
    function AirDropSameAMT(IERC20 token, address payable[] calldata to, uint256 amount) payable external{
        if(address(token) == address (0)){
            for(uint256 i = 0; i< to.length; i++){
